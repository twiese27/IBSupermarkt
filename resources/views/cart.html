...
<html lang="zxx">
  ...
  <body class="js">
    ...
    <!-- Include Header -->
    <div w3-include-html="/html/must-have/header.html"></div>
    ...
    <div w3-include-html="/html/must-have/shop-service-area.html"></div>
    ...
    <!-- Include Footer -->
    <div w3-include-html="/html/must-have/footer.html"></div>
