    ...
    <div class="breadcrumbs">
      ...
      <div class="row">
        ...
        <div class="bread-inner">
          ...
          <li class="active"><a href="blog-single.html">Shop Gitter</a></li>
          </ul>
        </div>
        </div>
      </div>
        ...
        <div class="shop-sidebar">
          ...
          <ul class="check-box-list"></ul>
            ...
            <label class="checkbox-inline" for="1"
              ><input name="news" id="1" type="checkbox" />$20 -
              $50<span class="count">(3)</span></label
            >
            </li>
            <li>
            <label class="checkbox-inline" for="2"
              ><input name="news" id="2" type="checkbox" />$50 -
              ...
              <div class="single-product">
                ...
                <div class="button-head">
                  ...
                  <a
                    ...
                    href="#"
                    ><i class="ti-eye"></i><span>Schnellansicht</span></a
                  >
                  <a title="Wunschliste" href="#"
                    ><i class="ti-heart"></i
                    ><span>Zur Wunschliste hinzufügen</span></a
                  >
                  <a title="Vergleichen" href="#"
                ...
                <h3>
                  <a href="product-details.html">Frauen Heiße Kollektion</a>
                </h3>
