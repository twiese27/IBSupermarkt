...
def create_sales_table():
    """Erstellt die Tabelle SALES_ALL_TIME, falls sie nicht existiert."""
    cursor = connection.cursor()
    
    create_table_sql = """
        CREATE TABLE SALES_ALL_TIME (
            SALES_ALL_TIME_ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ...
    try:
        ...
        print("Tabelle SALES_ALL_TIME erfolgreich erstellt.")
    except cx_Oracle.DatabaseError as e:
        error, = e.args
        if error.code == 955:  # ORA-00955: Name ist bereits vergeben
            print("Tabelle SALES_ALL_TIME existiert bereits.")
        else:
