...
def create_sales_table():
    """Erstellt die Tabelle SALES_LAST_MONTH, falls sie nicht existiert."""
    ...
    try:
        ...
        print("Tabelle SALES_LAST_MONTH erfolgreich erstellt.")
    except cx_Oracle.DatabaseError as e:
        error, = e.args
        if error.code == 955:  # ORA-00955: Name ist bereits vergeben
            print("Tabelle SALES_LAST_MONTH existiert bereits.")
        else:
